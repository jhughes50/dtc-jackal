...
class LiteralListener:
    ...
    def triggerCallback(self, msg : UInt8) -> None:
        ...
        if self.trigger_ == 0:
            ...
            path = "/home/dtc/ws/src/speakerer/config/HereToHelp.wav"
            self.soundhandle_.playWave(path)
            ...
            #volume = 1.0
            #self.soundhandle_.say(speech, voice, volume)
            path = "/home/dtc/ws/src/speakerer/config/LookAtCameraAndRemainStill.wav"
            self.soundhandle_.playWave(path)
            ...
            #volume = 1.0
            #self.soundhandle_.say(speech, voice, volume)
            path = "/home/dtc/ws/src/speakerer/config/WaveAndDescribeInjuries.wav"
            self.soundhandle_.playWave(path)
